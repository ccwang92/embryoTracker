...
void RayCastVolume::transfer_volume(void*data, double p_min, double p_max, long sx,
    ...
    if (sc == 1)
    {
        ...
        if(texture_format == V3D_UINT16) {
            glTexImage3D(GL_TEXTURE_3D, 0, GL_R16, m_size.x(), m_size.y(), m_size.z(),
...
//    m_volume_texture = new QOpenGLTexture(QOpenGLTexture::Target3D);
//    m_volume_texture->setMinMagFilters(QOpenGLTexture::Linear, QOpenGLTexture::Linear);
//    m_volume_texture->setWrapMode(QOpenGLTexture::Repeat); //include Direction S, T, R
//    m_volume_texture->create();
//    // given some width, height, depth, and data_ptr
//    m_volume_texture->setSize(sx, sy, sz);
    //int texture_format = ((RayCastCanvas*)glWidget)->getDataImporter()->image4d->getDatatype();
    //    image_type = ((RayCastCanvas*)glWidget)->getDataImporter()->image4d->getUnitBytes();
//    if (texture_format == V3D_UINT8){
//        m_volume_texture->setFormat(QOpenGLTexture::R8_UNorm); // GL_R8
//        m_volume_texture->allocateStorage();
//        m_noise_texture->setData(QOpenGLTexture::Red, QOpenGLTexture::UInt8,  data);//(const char*)
//    }
//    else if (texture_format == V3D_UINT16){
//        m_volume_texture->setFormat(QOpenGLTexture::R16_UNorm); // GL_R16
//        m_volume_texture->allocateStorage();
//        m_noise_texture->setData(QOpenGLTexture::Red, QOpenGLTexture::UInt16, (const char*) data);
//    }
}
...
//    m_noise_texture->setMinMagFilters(QOpenGLTexture::Nearest, QOpenGLTexture::Nearest);
//    m_noise_texture->setWrapMode(QOpenGLTexture::DirectionS, QOpenGLTexture::Repeat); //include
//    m_noise_texture->setWrapMode(QOpenGLTexture::DirectionT, QOpenGLTexture::Repeat);
//    m_noise_texture->create();
//    // given some `width`, `height` and `data_ptr`
//    m_noise_texture->setSize(width, height, 1);
//    m_noise_texture->setFormat(QOpenGLTexture::R8_UNorm);
//    m_noise_texture->allocateStorage();
//    m_noise_texture->setData(QOpenGLTexture::Red, QOpenGLTexture::UInt8, (const char*) noise);
}
...
//    m_cube_vao.paint();
//    if(m_noise_texture && m_noise_texture->isBound())
//        m_noise_texture->release();
//    if(m_volume_texture && m_volume_texture->isBound())
